  ...
  const mockCommunities: Community[] = [
    {
      ...
      description: "A group of farmers working together on cassava production",
      memberCount: 16,
      category: "Farming",
      isJoined: false,
    ...
    {
      id: "comm-2", 
      name: "Tomato Farmers Association",
      description: "An organization of farmers dedicated to enhancing tomato yield and quality.",
      memberCount: 25,
      category: "Farming",
      isJoined: false,
    ...
    {
      id: "comm-3",
      name: "Rice Cultivators Collective",
      description: "A cooperative focused on sustainable rice farming practices.",
      memberCount: 30,
      category: "Farming",
      isJoined: false,
    ...
    {
      id: "comm-4",
      name: "Organic Vegetable Producers",
      description: "A cooperative focused on sustainable rice farming practices.",
      memberCount: 20,
      category: "Organic",
      isJoined: false,
