      ...
      try {
        ...
        if (now < sessionData.expiry) {
          setUserData({
            ...
            userType: sessionData.userType || "farmer",
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="hidden md:flex min-h-screen items-center justify-center p-8">
        <div className="bg-white rounded-3xl shadow-xl p-8 w-full max-w-md">
          ...
          <div className="text-center mb-8">
            {/* Avatar */}
            <div className="w-32 h-32 bg-gradient-to-br from-green-500 to-green-700 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <span className="inline-block px-4 py-2 bg-green-100 text-green-800 font-medium rounded-full text-lg">
              🌱 {userData.userType.charAt(0).toUpperCase() + userData.userType.slice(1)}
            </span>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              data-testid="button-back-dashboard-desktop"
            >
              Back to Dashboard
            </Button>
          </div>
