...
export const BuyerOnboarding = (): JSX.Element => {
  ...
  if (isLoading) {
    return <LoadingSpinner fullScreen message="Loading buyer onboarding..." />;
  }

  const slides = [
    {
      id: 1,
      title: "Find Fresh Produce Near You",
      description: "Connect directly with farmers around you. Get fresh food straight from the source",
