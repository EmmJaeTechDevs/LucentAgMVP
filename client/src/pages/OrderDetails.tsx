...
interface OrderDetailsResponse {
  ...
  crop?: any; // We won't use this but it might be in the response
}
  ...
  useEffect(() => {
    const loadOrderDetails = async () => {
      ...
      try {
        ...
        console.log('Buyer Details:', orderData.buyer);
        console.log('=====================================');
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900 dark:text-gray-100 font-medium">
                    {orderDetails.quantityOrdered} units
                  </span>
                </div>
                <div className="flex justify-between text-sm">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 mb-6 shadow-sm border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    User Type: {orderDetails.buyer.userType}
                  </p>
                </div>
